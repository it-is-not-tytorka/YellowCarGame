LEXICON_EN: dict[str, str] = {
    "/start": 'This is a "Yellow Car Game".\nChoose "Upload a photo 🚖" or send /upload to upload a '
              "yellow car and increase your score.\n"
              'You can press "Check my balance 📊" or send /balance to see your score. '
              "If you want to see all images you've uploaded send me /see_all.\n"
              'If you want to spend one score and bit your friend - do it! Choose "Spend a score 🤜" or send /spend.\n'
    ...
    "kb_upload": "Upload a photo 🚖",
    "kb_check": "Check my balance 📊",
    "kb_spend": "Spend a score 🤜",
    ...
    "success_upload": "Congrats! Take your score 🥇",
    ...
    "success_spend": "Ohh yea! Hit harder 😎🍾",
